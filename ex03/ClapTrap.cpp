...
ClapTrap::ClapTrap( void ) :
    ...
    AttackDamage(0)
{
    std::cout << "ClapTrap: Default Constructor 1 called for " << Name << std::endl;
}
...
AttackDamage(0)
{
    std::cout << "ClapTrap: Default Constructor 2 called for " << Name << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& other)
{
    ...
    std::cout << "ClapTrap: Assignement Operator for " << Name << std::endl;
    return (*this);   
}
